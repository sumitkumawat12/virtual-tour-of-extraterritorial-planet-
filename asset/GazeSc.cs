...
public class GazeSc : MonoBehaviour
{
    ...
    public Transform sphere7Center; // Reference to the center position of Sphere 4
    ...
    void Start()
    {
        sphere6.SetActive(true);  // Start with Sphere 3 active
        sphere7.SetActive(false); // Sphere 4 is inactive initially
    }
    ...
    void MoveCameraToCenter()
    {
        ...
        Player.transform.position = sphere7Center.position;
        Player.transform.rotation = sphere7Center.rotation;
